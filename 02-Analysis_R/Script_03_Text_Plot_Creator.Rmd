...
```{r, echo=F, fig.height=3.3, fig.width=4.2, fig.cap="Memory accuracy in learning session probe trials" }
plot.ms + 
...
# 
# As a second step, we investigated age-related differences in the egocentric latent profile score (E-LPS). A higher E-LPS indicates that an individual expressed the latent profile more strongly, which was associated with better egocentric long-delay memory. One-way ANOVA revealed significant age group differences in E-LPS (`r apa_aov.plsc_ego$statistic`), indicating that there was a gradual increase in the expression of the E-LPS with increasing age (6-8YO vs. 9-11YO: `r apa_post.plsc_ego$statistic$YoungKids_OldKids`; 6-8YO vs. AD: `r apa_post.plsc_ego$statistic$YoungKids_YoungAdults`; 9-11YO vs AD: `r apa_post.plsc_ego$statistic$OldKids_YoungAdults`), thus, paralleling the age-related differences in egocentric long-term memory. The correlation coefficients between egocentric long-delay memory and E-LPS did not differ between age groups (6-8YO $r$ = `r apa_cor_r.plsc_ego$"6-8YO"`, 9-11YO: $r$ = `r apa_cor_r.plsc_ego$"9-11YO"`, AD: $r$ = `r apa_cor_r.plsc_ego$"AD"`; 6-8YO vs. 9-11YO: $p$ `r apa_cor_p.plsc_ego$"6-8YO vs. 9-11YO"`; 6-8YO vs. AD: $p$ `r apa_cor_p.plsc_ego$"6-8YO vs. AD"`; 9-11YO vs. AD: $p$ `r apa_cor_p.plsc_ego$"9-11YO vs. AD"`). 
...
# 
# As a second step, we investigated age-related differences in the allocentric latent profile score (A-LPS). A higher A-LPS indicates that an individual expressed the latent profile more strongly, which was associated with better allocentric long-delay memory. One-way ANOVA revealed significant age group differences in A-LPS (`r apa_aov.plsc_allo$statistic`), indicating that there was a gradual increase in the expression of the A-LPS with increasing age (6-8YO vs. 9-11YO: `r apa_post.plsc_allo$statistic$YoungKids_OldKids`; 6-8YO vs. AD: `r apa_post.plsc_allo$statistic$YoungKids_YoungAdults`; 9-11YO vs AD: `r apa_post.plsc_allo$statistic$OldKids_YoungAdults`), thus, paralleling the age-related differences in allocentric long-term memory. The correlation coefficients between allocentric long-delay memory and A-LPS did not differ between age groups (6-8YO $r$ = `r apa_cor_r.plsc_allo$"6-8YO"`, 9-11YO: $r$ = `r apa_cor_r.plsc_allo$"9-11YO"`, AD: $r$ = `r apa_cor_r.plsc_allo$"AD"`; 6-8YO vs. 9-11YO: $p$ `r apa_cor_p.plsc_allo$"6-8YO vs. 9-11YO"`; 6-8YO vs. AD: $p$ `r apa_cor_p.plsc_allo$"6-8YO vs. AD"`; 9-11YO vs. AD: $p$ `r apa_cor_p.plsc_allo$"9-11YO vs. AD"`).
