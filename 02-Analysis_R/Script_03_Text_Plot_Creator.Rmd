...
Next, we wanted know how well participants from different age groups were able to form egocentric and allocentric spatial memories during the learning session. We computed a LMM with the memory score and tested for condition (egocentric vs. allocentric) and age differences (Table 3; Figure 2B). 
...
SUPPLEMENT: Participants in all age groups reached above chance-level performance. Tests against 0.5 for 
6-8YO: `r apa_post.ms_group_chance$full_result$YoungKids`; 9-11YO: `r apa_post.ms_group_chance$full_result$OldKids`; AD: `r apa_post.ms_group_chance$full_result$YoungAdults`. 
...
In summary, adults had a superior spatial knowledge at the end of the experiment, both regarding the geometrical structure of the maze and the landmark positioning. On the other hand, both groups of children were as proficient as adults in identifying environmental landmarks. 
