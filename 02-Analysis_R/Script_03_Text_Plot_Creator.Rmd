...
ggsave("../WP10_data/Plots/latency_train.jpg", plot.latency_train, width=4.0, height=3.0, dpi=600)

plot.path_train <- plot.path_train + theme(legend.position="none")
ggsave("../WP10_data/Plots/path_train.jpg", plot.path_train, width=4.0, height=3.0, dpi=600)

plot.distance_train <- plot.distance_train + theme(legend.position="none")
ggsave("../WP10_data/Plots/distance_train.jpg", plot.distance_train, width=4.0, height=3.0, dpi=600)

plot.initial_rotation_train <- plot.initial_rotation_train + theme(legend.position="none")
ggsave("../WP10_data/Plots/initial_rotation_train.jpg", plot.initial_rotation_train, width=4.0, height=3.0, dpi=600)
...
ggsave("../WP10_data/Plots/memory_probe_1.jpg", plot.ms, width=4.0, height=3.0, dpi=600)
...
```{r, echo=F, fig.height=3.5, fig.width=4.8, fig.cap="Spatial memmory consolidation across session" }
plot.ms_all + 
  guides(fill=F, shape=F) & 
  theme(legend.position="right", legend.justification="top")

plot.ms_all <- plot.ms_all + theme(legend.position="none")
ggsave("../WP10_data/Plots/memory_probe_con.jpg", plot.ms_all, width=4.8, height=3.5, dpi=600)
...
ggsave("../WP10_data/Plots/post_layout.jpg", plot.layout, width=2.5, height=3.3, dpi=600)

plot.landmark <- plot.landmark + theme(legend.position="none")
ggsave("../WP10_data/Plots/post_landmark.jpg", plot.landmark, width=2.5, height=3.3, dpi=600)

plot.position <- plot.position + theme(legend.position="none")
ggsave("../WP10_data/Plots/post_position.jpg", plot.position, width=2.5, height=3.3, dpi=600)
...
```{r, echo=F, fig.height=3.5, fig.width=4.8, fig.cap="Spatial memory consolidation across sessions for well-learned pairs" }
plot.ms_wl + 
  guides(fill=F, shape=F) & 
  theme(legend.position="right", legend.justification="top")

plot.ms_wl <- plot.ms_wl + theme(legend.position="none")
ggsave("../WP10_data/Plots/memory_probe_con_wl.jpg", plot.ms_wl, width=4.8, height=3.5, dpi=600)
...
ggsave("../WP10_data/Plots/latency_probe.jpg", plot.latency_probe, width=4.2, height=3.3, dpi=600)

plot.path_probe <- plot.path_probe + theme(legend.position="none")
ggsave("../WP10_data/Plots/path_probe.jpg", plot.path_probe, width=4.2, height=3.3, dpi=600)

plot.distance_probe <- plot.distance_probe + theme(legend.position="none")
ggsave("../WP10_data/Plots/distance_probe.jpg", plot.distance_probe, width=4.2, height=3.3, dpi=600)

plot.initial_rotation_probe <- plot.initial_rotation_probe + theme(legend.position="none")
ggsave("../WP10_data/Plots/initial_rotation_probe.jpg", plot.initial_rotation_probe, width=4.2, height=3.3, dpi=600)
