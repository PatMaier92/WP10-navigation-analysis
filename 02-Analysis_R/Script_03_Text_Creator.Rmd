...
*trial in block* (`r apa_lmm.train_latency$statistic$trial_in_block`)
*age group* (`r apa_lmm.train_latency$statistic$group`)
...
*trial in block* (`r apa_lmm.train_path$statistic$trial_in_block`)
*age group* (`r apa_lmm.train_path$statistic$group`)
...
*trial in block* (`r apa_lmm.train_distance$statistic$trial_in_block`)
*age group* (`r apa_lmm.train_distance$statistic$group`)
...
*interaction* (`r apa_lmm.train_initial_rotation$statistic$group_trial_in_block`)
...
Next, we wanted to look at navigation efficiency during learning, starting with latency. For latency, the *age group* effect (`r apa_lmm.latency_probe$statistic$group`, $\omega^2 =$ `r apa_post.latency_probe_omega_group`), *condition* effect (`r apa_lmm.latency_probe$statistic$condition`, $\omega^2 =$ `r apa_post.latency_probe_omega_condition`) and *age group x condition* interaction were significant (`r apa_lmm.latency_probe$statistic$group_condition`, $\omega^2 =$ `r apa_post.latency_probe_omega_group_condition`). Post-hoc contrasts revealed that participants from all age groups had a higher latency in the allocentric condition (egocentric vs. allocentric in 6-8-yo: `r apa_post.latency_probe_group_condition$statistic$YoungKids_Egoret_alloret`; 9-11-yo: `r apa_post.latency_probe_group_condition$statistic$OldKids_Egoret_alloret`; adults: `r apa_post.latency_probe_group_condition$statistic$YoungAdults_Egoret_alloret`). 6-8-yo children had a higher latency than adults in the egocentric (`r apa_post.latency_probe_group_condition$statistic$Egoret_YoungKids_YoungAdults`) and allocentric condition (`r apa_post.latency_probe_group_condition$statistic$Alloret_YoungKids_YoungAdults`). There was a trend for a significant difference between 9-11-yo children and adults in allocentric (`r apa_post.latency_probe_group_condition$statistic$Alloret_OldKids_YoungAdults`).
...
For excess path length, the *age group* effect (`r apa_lmm.path_probe$statistic$group`, $\omega^2 =$ `r apa_post.path_probe_omega_group`), *condition* effect (`r apa_lmm.path_probe$statistic$condition`, $\omega^2 =$ `r apa_post.path_probe_omega_condition`) and *age group x condition* interaction were significant (`r apa_lmm.path_probe$statistic$group_condition`, $\omega^2 =$ `r apa_post.path_probe_omega_group_condition`). Post-hoc contrasts revealed that participants from all age groups had longer excess path lengths in the allocentric condition (egocentric vs. allocentric in 6-8-yo: `r apa_post.path_probe_group_condition$statistic$YoungKids_Egoret_alloret`; 9-11-yo: `r apa_post.path_probe_group_condition$statistic$OldKids_Egoret_alloret`; adults: `r apa_post.path_probe_group_condition$statistic$YoungAdults_Egoret_alloret`). In the egocentric condition, 6-8-yo children had significantly longer excess paths than adults (`r apa_post.path_probe_group_condition$statistic$Egoret_YoungKids_YoungAdults`), in the allocentric condition there was a gradual decrease in excess path with increasing age (6-8-yo vs. adults: `r apa_post.path_probe_group_condition$statistic$Alloret_YoungKids_YoungAdults`; 6-8-yo vs. 9-11-yo: `r apa_post.path_probe_group_condition$statistic$Alloret_YoungKids_OldKids`;9-11-yo vs. adults: `r apa_post.path_probe_group_condition$statistic$Alloret_OldKids_YoungAdults`).
...
For excess distance to goal, we found a significant main effect for *age group* (`r apa_lmm.distance_probe$statistic$group`, $\omega^2 =$ `r apa_post.distance_probe_omega_group`). Post-hoc contrasts revealed a gradual decrease in excess distance to goal with increasing age, meaning that that older participants searched in closer proximity to the actual goal locations (6-8-yo vs. 9-11-yo: `r apa_post.distance_probe_group$statistic$YoungKids_OldKids`; 6-8-yo vs. adults: `r apa_post.distance_probe_group$statistic$YoungKids_YoungAdults`; 9-11-yo vs. adults: `r apa_post.distance_probe_group$statistic$OldKids_YoungAdults`). Additionally, there was a main effect of *condition* (`r apa_lmm.distance_probe$statistic$condition`, $\omega^2 =$ `r apa_post.distance_probe_omega_condition`), with an increased excess distance to goal in the allocentric compared to the egocentric condition.
...
For initial rotation, there was a significant main effect for *condition* (`r apa_lmm.init_rot_probe$statistic$condition`, $\omega^2 =$ `r apa_post.initial_rotation_probe_omega_condition`). All groups had significantly higher initial rotation velocity in the allocentric condition (`r apa_post.init_rot_probe_condition$statistic`). 
