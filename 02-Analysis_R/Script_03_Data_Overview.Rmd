...
rm(post.ms_group, post.ms_group_chance, post.ms_condition, LRT.ms)
```
...
```{r, include=F}
rm(model.ms, R2, apa_lmm.ms, apa_post.ms_group, apa_post.ms_group_chance, apa_post.ms_condition, apa_post.ms_group_condition, apa_rs.condition)
```
...
rm(post.time_group_session, post.time_group_condition, post.time_session_condition, LRT.time)
```
...
```{r, include=F}
rm(model.time, R2, apa_lmm.time, apa_post.time_group_session, apa_post.time_group_condition, apa_post.time_session_condition, apa_rs.condition)
```
...
rm(post.path_group_session, post.path_group_condition, post.path_session_condition, LRT.path)
```
...
```{r, include=F}
rm(model.path, apa_lmm.path, apa_post.path_group_session, apa_post.path_group_condition, apa_post.path_session_condition, apa_rs.condition)
```
...
rm(post.distance_group, post.distance_session, post.distance_condition, LRT.distance)
```
...
```{r, include=F}
rm(model.distance, apa_lmm.distance, apa_post.distance_group, apa_post.distance_session, apa_post.distance_condition, apa_rs.condition)
```
...
rm(post.init_vel_group_condition, post.init_vel_session_condition, LRT.rotation_velocity)
```
...
```{r, include=F}
rm(model.rotation_velocity, apa_lmm.init_vel, apa_post.init_vel_group_condition, apa_post.init_vel_session_condition, apa_rs.condition)
```
