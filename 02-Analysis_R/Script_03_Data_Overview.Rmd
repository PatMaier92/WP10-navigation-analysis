...
```{r, include=F}
rm(model.initial_rotation_learn, R2, apa_lmm.learn_initial_rotation)
```
...
#rm(plot.time_learn, plot.path_learn, plot.distance_learn, plot.initial_rotation_learn)
```
...
mc_time <- mc_plot(practise, "group", "time", group_colors_f, group_labels, l_latency)
