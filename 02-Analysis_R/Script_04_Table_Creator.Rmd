...
# random effects
apa_LRT.rotation_velocity <- tibble("Grouping" = c("Id", "Id", "Id")) %>% 
  cbind("Random effect" = c("(Intercept)", "Condition1", "(Intercept) X Condition1")) %>% 
  cbind("p.value" = c(NA, LRT.rotation_velocity$p %>% apa_p(), NA)) 

apa_rotation_velocity_random <- apa_random_table(VarCorr(model.rotation_velocity$full_model), apa_LRT.rotation_velocity) 


rm(apa_lmm.rotation_velocity, omega.rotation_velocity, apa_omega.rotation_velocity, LRT.rotation_velocity, apa_LRT.rotation_velocity, model.rotation_velocity)
```
...
rm(apa_ms_fixed, apa_latency_fixed, apa_path_fixed, apa_distance_fixed, apa_rotation_velocity_fixed)
```
...
apa_table(
  cbind(apa_ms_random,
        ...
        apa_rotation_velocity_random %>% list_modify("Grouping"=NULL, "Random effect"=NULL))
)

rm(apa_ms_random, apa_latency_random, apa_path_random, apa_distance_random, apa_rotation_velocity_random)
```
