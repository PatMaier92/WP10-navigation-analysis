...
Correlation_LPS <- c("egocentric 1", "egocentric 2", "allocentric 1", "allocentric 2")
...
apa_table(cbind(
  Correlation_LPS,
  rbind(apa_model.lp_n_ego_1$table,
        apa_model.lp_n_ego_2$table,
        apa_model.lp_n_allo_1$table,
        apa_model.lp_n_allo_2$table),
  s1_vs_s2,
  ego_vs_allo))

rm(apa_model.lp_n_ego_1, apa_model.lp_n_ego_2, apa_model.lp_n_allo_1, apa_model.lp_n_allo_2)
```

ego 1 vs ego 2 (`r p_bonferroni4` `r apa_model.p_lp_n_ego`)
allo 1 vs allo 2 (`r p_bonferroni4` `r apa_model.p_lp_n_allo`)
ego 1 vs allo 1 (`r p_bonferroni4` `r apa_model.p_lp_n_ego_allo_1`)
ego 2 vs allo 2 (`r p_bonferroni4` `r apa_model.p_lp_n_ego_allo_2`)
...
apa_table(cbind(
  Correlation_LPS,
  rbind(apa_model.lp_p_ego_1$table,
        apa_model.lp_p_ego_2$table,
        apa_model.lp_p_allo_1$table,
        apa_model.lp_p_allo_2$table),
  s1_vs_s2,
  ego_vs_allo))

rm(apa_model.lp_p_ego_1, apa_model.lp_p_ego_2, apa_model.lp_p_allo_1, apa_model.lp_p_allo_2, Correlation_LPS, s1_vs_s2, ego_vs_allo)
```

ego 1 vs ego 2 (`r p_bonferroni4` `r apa_model.p_lp_p_ego`)
allo 1 vs allo 2 (`r p_bonferroni4` `r apa_model.p_lp_p_allo`)
ego 1 vs allo 1 (`r p_bonferroni4` `r apa_model.p_lp_p_ego_allo_1`)
ego 2 vs allo 2 (`r p_bonferroni4` `r apa_model.p_lp_p_ego_allo_2`)
...
rm(apa_lmm.latency_probe, omega.latency_probe, apa_omega.latency_probe, LRT.latency_probe, apa_LRT.latency, model.latency_probe)
```
