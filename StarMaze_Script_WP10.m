...
[sm.sub{p}.session{s}.trial{k}.chosen_goal_str,sm.sub{p}.session{s}.trial{k}.chosen_goal_int]=sm_wp10_chosenGoalAlley(string(trial_data.chosen_goal(k,1)));
...
col_header={'wp','date_analysis','id','sex','group','session',...
    ...
    'goal_position','goal_identity','chosen_goal'};
...
group_var=[sm.sub{p}.wp convertCharsToStrings(date) sm.sub{p}.id sm.sub{p}.sex sm.sub{p}.group Session ...
    sm.sub{p}.session{s}.trial{k}.trial_num sm.sub{p}.session{s}.trial{k}.trial_condition ...
    sm.sub{p}.session{s}.trial{k}.fb sm.sub{p}.session{s}.trial{k}.start ...
