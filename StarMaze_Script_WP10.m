...
col_header_4={'goal_x','goal_y','goal_x_ego','goal_y_ego','ideal_path','ideal_path_ego',...
...
xlswrite(new_file,strrep([group_var sm.sub{p}.session{s}.trial{k}.result.time sm.sub{p}.session{s}.trial{k}.result.time_accuracy ...
    ...
    sm.sub{p}.session{s}.trial{k}.result.path_explored sm.sub{p}.session{s}.trial{k}.result.path_score],'.', ','),'path','A2');
