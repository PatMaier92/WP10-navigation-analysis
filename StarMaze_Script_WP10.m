...
% main exploration variables 
col_header_3={'search_strategy_no','direct','reoriented','serial','central_focus','random_search',...
...
col_header_4={'goal_x_ego','goal_y_ego','ideal_path','ideal_path_ego',...
