...
[sm.sub{p}.session{s}.trial{k}.result.success, sm.sub{p}.session{s}.trial{k}.result.success_ego,...
    ...
    sm.sub{p}.session{s}.trial{k}.chosen_goal);
...
sm.sub{p}.session{s}.trial{k}.result.direct_path=sm_wp10_directPath(sm.sub{p}.session{s}.trial{k}.start,...
    ...
    sm.sub{p}.session{s}.trial{k}.result.correct_final_alley,... %or use sm.sub{p}.session{s}.trial{k}.result.success,...
...
[sm.sub{p}.session{s}.trial{k}.searchStrategy.direct_run,sm.sub{p}.session{s}.trial{k}.searchStrategy.reoriented,sm.sub{p}.session{s}.trial{k}.searchStrategy.serial,sm.sub{p}.session{s}.trial{k}.searchStrategy.central_focus,sm.sub{p}.session{s}.trial{k}.searchStrategy.random_search,sm.sub{p}.session{s}.trial{k}.searchStrategy.unclassified,sm.sub{p}.session{s}.trial{k}.searchStrategy.failed_strategy,...
 ...
 sm.sub{p}.session{s}.trial{k}.result.path_score,sm.sub{p}.session{s}.trial{k}.result.arm_score,sm.sub{p}.session{s}.trial{k}.zone.rel_pentagon_zone, sm.sub{p}.session{s}.trial{k}.zone.alley_zone_out);
...
col_header_2={'time_abs','time_accuracy','path_abs','path_accuracy','final_distance_to_goal_abs',...
    ...
    'arm_score', 'path_score', 'direct_path'};
...
col_header_3={'alley_1_abs','alley_2_abs','alley_3_abs','alley_4_abs','alley_5_abs','pe_abs',...
    ...
    'entry_tri_1', 'entry_tri_2', 'entry_tri_3', 'entry_tri_4', 'entry_tri_5',...
...
xlswrite(new_file,strrep([group_var sm.sub{p}.session{s}.trial{k}.result.time sm.sub{p}.session{s}.trial{k}.result.time_accuracy ...
    ...
    sm.sub{p}.session{s}.trial{k}.result.arm_score sm.sub{p}.session{s}.trial{k}.result.path_score sm.sub{p}.session{s}.trial{k}.result.direct_path],'.', ','),'path','A2');
