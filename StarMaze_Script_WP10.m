...
% @ date 20201104 update by @ Patrizia Maier
...
% Check functions, whether you have to adjust for alterations of the maze
% or whether your folders are called correctly
...
% Besides, the script assumes you have a log.csv-file and a file called "trial_results.csv"

% Block 3:
% Read-in of cleaned tracker trial xlsx-files. 
% The actual analysis starts, i.e. calculation of variables. 
