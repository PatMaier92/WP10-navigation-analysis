...
if sm.sub{p}.session{s}.trial{k}.trial_condition==4
    ...
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_in(1,1)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_in(1,2)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_in(1,3)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_in(1,4)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_in(1,5)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_out(1,1)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_out(1,2)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_out(1,3)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_out(1,4)=999; 
    sm.sub{p}.session{s}.trial{k}.zone.alley_rotations_out(1,5)=999; 
