...
%     %
    ...
    pt.sub{p}.session{s}.lm_MB=trial_data.lm_MB{1,1}(1:2);
    pt.sub{p}.session{s}.lm_MD=trial_data.lm_MD{1,1}(1:2);
    pt.sub{p}.session{s}.lm_MF=trial_data.lm_MF{1,1}(1:2);
    pt.sub{p}.session{s}.lm_MH=trial_data.lm_MH{1,1}(1:2);
    pt.sub{p}.session{s}.lm_MJ=trial_data.lm_MJ{1,1}(1:2);
    pt.sub{p}.session{s}.obj_MA=trial_data.obj_MA{1,1}(1:2);
    pt.sub{p}.session{s}.obj_MC=trial_data.obj_MC{1,1}(1:2);
    pt.sub{p}.session{s}.obj_MI=trial_data.obj_MI{1,1}(1:2);
...
for k=1:size(trial_data,1)
    ...
    if k==1
        pt.sub{p}.session{s}.obj_1=trial_data.obj_1{1,1}(1);
    elseif k==2 
        pt.sub{p}.session{s}.obj_1=trial_data.obj_1{2,1}(1:2);
        pt.sub{p}.session{s}.obj_2=trial_data.obj_2{2,1}(1:2);
        pt.sub{p}.session{s}.obj_3=trial_data.obj_3{2,1}(1:2);
        pt.sub{p}.session{s}.obj_4=trial_data.obj_4{2,1}(1:2);
        pt.sub{p}.session{s}.obj_5=trial_data.obj_5{2,1}(1:2);
    elseif k==3 
      pt.sub{p}.session{s}.obj_1=trial_data.obj_1{3,1}(1:2);
      pt.sub{p}.session{s}.obj_2=trial_data.obj_2{3,1}(1:2);
      pt.sub{p}.session{s}.obj_3=trial_data.obj_3{3,1}(1:2);
    end
