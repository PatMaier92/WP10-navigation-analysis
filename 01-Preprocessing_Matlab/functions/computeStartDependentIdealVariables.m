function [goal_x_ego, goal_y_ego, ego_alley,...
    x_line, y_line, o_x_line, o_y_line, x_line_chosen, y_line_chosen,...
    x_line_ego, y_line_ego, ideal_path, ideal_path_chosen,... 
    ideal_ego_path]=computeStartDependentIdealVariables(Graph,...
