...
**In allocentric trials: How often did participants erroneously pick the egocentric goal alley** (only trials with unambiguous egocentric location)
...
**Exploration allocentric trials: What percentage did participants spend in zones indicating an egocentric or homing strategy** (only trials where egocentric alley is not original start alley and with defined egocentric location)

```{r, warning=F, echo=F, fig.height=4 }

box_allo_pres +  
  plot_annotation("Exploration of presence in allocentric probe trials") + 
  plot_layout(guides="collect") & theme(legend.position="bottom", legend.justification=c(0,0))
