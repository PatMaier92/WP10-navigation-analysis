...
```{r, include=F}
rm(probe.memory_s, R2, apa_lmm, apa_emm1, apa_emm2)
```
...
emm1 <- contrast(emm1, con_list_group_location_session, adjust="bonferroni") # 27 comparisons
...
```{r, include=F}
rm(probe.memory_goals, R2, apa_lmm, apa_emm1, apa_emm2)
```
...
emm1 <- contrast(emm1, con_list_group_session, adjust="bonferroni")
apa_emm1 <- apa_print(emm1)
apa_emm1 <- apa_emm1$table %>% remove_rownames()
rm(emm1)
...
emm3 <- contrast(emm3, con_list_session_condition, adjust="bonferroni")
apa_emm3 <- apa_print(emm3)
apa_emm3 <- apa_emm3$table %>% remove_rownames()
rm(emm3)
...
emm4 <- contrast(emm4, con_list_group_session_condition, adjust="bonferroni")
apa_emm4 <- apa_print(emm4)
apa_emm4 <- apa_emm4$table %>% remove_rownames()
rm(emm4)
