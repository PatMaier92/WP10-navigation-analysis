...
### **Explorative: Memory score (all trials) with interactions with goal locations**
...
(ref:p-pa-caption0) Fixed effects for excess path in probe trials.
...
(ref:p-ir-caption0) Fixed effects for excess path in probe trials.
