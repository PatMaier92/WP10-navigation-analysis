...
emm1 <- rbind(emm1_1$contrast, emm1_2) %>% mutate(p.value=ifelse(p.value*6>1, 1, p.value*6))
apa_emm1 <- apa_print(emm1)
apa_emm1 <- apa_emm1$table %>% remove_rownames()
...
emm3 <- rbind(emm3_1$contrast, emm3_2) %>% mutate(p.value=ifelse(p.value*3>1, 1, p.value*3))
...
emm4 <- rbind(emm4_1, emm4_2) %>% mutate(p.value=ifelse(p.value*15>1, 1, p.value*15))
