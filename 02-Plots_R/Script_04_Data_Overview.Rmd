...
* group * session interaction (marginal, contrasts tbd) 
* group * condition interaction (marginal, contrasts tbd)
* condition * session interaction (marginal, contrasts tbd)
* group effect: 6-7-year-old children significantly slower than adults  
* strong condition effect: allocentric trials significantly slower than egocentric 
...
```{r }
emmeans(probe.time_s$full_model, pairwise ~ group, lmer.df="satterthwaite", adjust="bonferroni")$contrasts
emmeans(probe.time_s$full_model, pairwise ~ condition, lmer.df="satterthwaite", adjust="bonferroni")$contrasts
```
...
* group * session interaction (contrasts tbd) 
* group * condition interaction (contrasts tbd)
* condition * session interaction (contrasts tbd)
* group effect: 6-7-year-old children significantly less direct paths than adult; 9-10-year-old children significantly less direct paths than adults
* strong condition effect: allocentric trials significantly less direct paths than egocentric 
...
```{r }
emmeans(probe.excess_path_s$full_model, pairwise ~ group, lmer.df="satterthwaite", adjust="bonferroni")$contrasts
emmeans(probe.excess_path_s$full_model, pairwise ~ condition, lmer.df="satterthwaite", adjust="bonferroni")$contrasts
```

```{r, include=F}
rm(probe.excess_path_s)
```
...
* condition * session interaction: 1) in egocentric trials relatively more time spend in outer alleys (compared to inner ring), whereas in allocentric trials more time spend in inner ring (compared to outer alleys). 2) in egocentric trials no change across sessions, whereas in allocentric trials the presence in outer alleys decreases across sessions. 
* covariates: block significant, trial_in_block and sex not significant 
...
```{r }
emm <- emmeans(probe.presence_alleys_s$full_model, ~ session * condition, lmer.df="satterthwaite")
emm
contrast(emm, con_list_session_condition, adjust="bonferroni")
```
...
* group * session * condition interaction (contrasts tbd)
* group * session interaction (contrasts tbd)
* session * condition interaction (contrasts tbd)
* group * session interaction (contrasts tbd)
* session main effect (contrasts tbd)
* condition main effect (contrasts tbd) 
