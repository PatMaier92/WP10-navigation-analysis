...
* **Direct**: Shortest path to chosen goal location (not necessarily correct goal location) without re-entry of zones. 
* **Detour**: Non-direct path without re-entry of zones. 
* **Reoriented**: Non-direct path with re-entry of zones. 
