...
learn.time_log <- mixed(time_log ~ group*block_f*trial_in_cond_c + (block_f|id), 
                    data=data_l, expand_re=T,
                    control=lmerControl(optimizer="bobyqa", optCtrl=list(maxfun=1e6)))
# check model
...
# # post-test
# emtrends(learn.time_var_log, pairwise ~ group, var="trial_in_cond_0", adjust="bonferroni")
# emtrends(learn.time_var_log, pairwise ~ block_f, var="trial_in_cond_0", adjust="bonferroni")
# emmeans(learn.time_var_log, pairwise ~ group | block_f, adjust="bonferroni", mode="satterthwaite")
