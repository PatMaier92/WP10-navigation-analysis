...
# emmeans::emmeans(mixed.full_opt_lrt_2, pairwise ~ group, 
#                  type="response", adjust="bonferroni")
# emmeans::emmeans(mixed.full_opt_lrt_2, pairwise ~ session, 
#                  type="response")

# summary(glht(mixed.full_opt_lrt_2$full_model, linfct=mcp(group='Tukey')))

```

```{r stats_path1}

# performance::check_model(mixed.full_opt_lrt_2$full_model)

# emmeans::emmeans(mixed.full_opt_lrt_2, "group")
# emmeans::contrast(mixed.full_opt_lrt_2, "group")
