...
learn.time_var_p <- update(learn.time_base, weights=varPower(form=~time | group))

anova(learn.time_base, learn.time_var, learn.time_var_p)

plot(learn.time_var_p, resid(., type="p") ~ fitted(.) | group, abline=0)
plot(learn.time_var_p, group ~ resid(., type="p"))
plot(learn.time_var_p, block_f ~ resid(., type="p"))
