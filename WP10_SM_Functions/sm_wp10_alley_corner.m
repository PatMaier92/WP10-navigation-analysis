...
disp('The function sm_wp10_alley_corner is deactivated'); 

% % SM_WP10_ALLEY_CORNER Normalized xy-coordinates for alleys (outer arms) of 5-arm
% % Starmaze in WP10. Each alley is a rectangle consisting of 4 points.
% % Point coordinates are defined in this function. 
% %
% % Input:
% % xmin,xmax,ymin,ymax are minimum, maximum coordinates of Starmaze WP10. 
% %
% % Returns 2x4 normalized xy-coordinates for 5 alleys (outer arms), i.e. 40
% % values in total. 
% 
% % Alley 1
